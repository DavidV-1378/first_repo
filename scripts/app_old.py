from scripts.models_old import A, Book, Library, BankAccount, ToDoItem, SafeCounter as sc, TagEntry, TagTracker, Order, OrderItem, Expense_2
...
# Order calss: customer, status, items, that supports: len(order), check by OrderItem equality, if order: 
